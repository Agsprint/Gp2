                ...
                <div class="side" style="position: absolute;">
                    <ul id="nav">
                        <li class="y_css" id="xx2" onmouseover="show(1)" onmouseout="hidden1(1)">
                            <a href="${pageContext.request.contextPath}/stuSearchResource.jsp" target="mainFrame" ><span></span>
                                <p class="icon_01">资料区</p>
                            </a></li>
                        <li class="y_css" id="xx3">
                            <a href="${pageContext.request.contextPath}/teacherAnswer.jsp" onclick="changeIcon('Notice')" target="mainFrame" onmousedown="javascript:pr('xx2')"
                               onmouseover="show(2)" onmouseout="hidden1(2)"><span></span>
                                <p class="icon_10">讨论区</p>
                            </a></li>
                        <li class="y_css" id="xx4">
                            <a href="${pageContext.request.contextPath}/resourceDetailDisplay.jsp" target="mainFrame" onclick="changeIcon('KnowLedge')"
                               onmousedown="javascript:pr('xx3')" onmouseover="show(3)" onmouseout="hidden1(3)">
                                <span></span>
                                <p class="icon_02">作业区</p>
                            </a></li>
                        <li class="y_css" id="xx5">
                            <a href="${pageContext.request.contextPath}/stuPersonMessage.jsp" onclick="changeIcon('Task')" target="mainFrame" onmousedown="javascript:pr('xx4')"
                               onmouseover="show(4)" onmouseout="hidden1(4)"><span></span>
                                <p class="icon_04">个人信息</p>
                            </a></li>
                    </ul>
                </div>
            </td>
