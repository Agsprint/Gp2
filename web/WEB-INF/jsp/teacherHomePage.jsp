                ...
                <div class="side" style="position: absolute;">
                    <ul id="nav">
                        <li class="y_css" id="xx2" onmouseover="show(1)" onmouseout="hidden1(1)">
                            <a href="${pageContext.request.contextPath}/teaUploadedResource.jsp" target="mainFrame" ><span></span>
                                <p class="icon_01">资料区</p>
                            </a></li>
                        <li class="y_css" id="xx3">
                            <a href="${pageContext.request.contextPath}/teacherDaYI.jsp" onclick="changeIcon('Notice')" target="mainFrame" onmousedown="javascript:pr('xx2')"
